...
let DashboardController = class DashboardController {
    ...
    async getSalesTrend(businessId, days) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get today\'s KPIs' }),
    __param(0, (0, current_user_decorator_1.CurrentBusiness)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "getTodayKpis", null);
__decorate([
    (0, common_1.Get)('trend'),
    (0, swagger_1.ApiOperation)({ summary: 'Get revenue trend over N days' }),
